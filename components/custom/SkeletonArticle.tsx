...
function SkeletonArticle({ className, ...props }: SkeletonProps) {
    return (
      <article
        className={cn(
         "p-6 bg-gray-200 rounded-lg border border-gray-300 shadow-md dark:bg-gray-700 dark:border-gray-600 animate-pulse" ,
          className
        )}
        {...props}
      >
        ...
        <div className="mb-2 w-full h-6 bg-gray-400 rounded"></div>
        <div className="mb-2 w-full h-4 bg-gray-400 rounded"></div>
        <div className="mb-5 w-[70%] h-4 bg-gray-400 rounded"></div>
