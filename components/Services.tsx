...
import DraggableSlider from "./DragableSlider";
  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 w-full">
        ...
        <DraggableSlider className="relative w-full overflow-x-scroll scrollbar-hide">
            <div className="flex space-x-4">
            {/* Item 1 */}
            <div className="flex-shrink-0 w-64 h-40 bg-red-500 rounded-md shadow-lg"></div>
            {/* Item 2 */}
            <div className="flex-shrink-0 w-64 h-40 bg-blue-500 rounded-md shadow-lg"></div>
            {/* Item 3 */}
            <div className="flex-shrink-0 w-64 h-40 bg-green-500 rounded-md shadow-lg"></div>
            {/* Item 4 */}
            <div className="flex-shrink-0 w-64 h-40 bg-yellow-500 rounded-md shadow-lg"></div>
            {/* Item 5 */}
            <div className="flex-shrink-0 w-64 h-40 bg-purple-500 rounded-md shadow-lg"></div>
            </div>
        </DraggableSlider>
    </div>
  );
